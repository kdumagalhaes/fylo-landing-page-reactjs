      ...
      <ContentDiv>
        <div>
          <Logo margin="0 0 20px 0">
            <a href="/#">
              <img src={LogoWhiteSVG} alt="fylo description SEO" />
            </a>
          </Logo>
          <ContactInfo />
        </div>
        ...
        <SocialLinks>
          <li>
            <a href="/#">
              <Icon icon={socialFacebookCircular} width="30" />
            </a>
          </li>
          <li>
            <a href="/#">
              <Icon icon={socialTwitterCircular} width="30" />
            </a>
          </li>
          <li>
            <a href="/#">
              <Icon icon={socialInstagramCircular} width="30" />
            </a>
          </li>
        </SocialLinks>
      </ContentDiv>
